  ...
  return (
    <>
      <Container className="py-4">
        <div className="row">
          <div key={company?.id} className="col-12 mb-2">
            <Link
            ...
            >
              <Card className="mb-4">
                <div className="d-flex justify-content-center align-items-center mt-3">
                  <img
                    src={company?.logoSecureUrl} // Accessing logo from the company data
                    alt={company?.name}
                ...
                <Card.Body>
                  ...
                  <Row className="mb-3">
                    <Col
                      ...
                      className="text-center"
                    >
                      <FaMapMarker size="25" style={{ color: "green" }} />{" "}
                      {company?.country?.name} ,<br />
                      {company?.state?.statename},{company?.city?.name}
                    </Col>
                  </Row>
                  <Row>
                    {/* <Col
