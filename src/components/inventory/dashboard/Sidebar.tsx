...
export default function Sidebar({ session, notifications = [] }: SidebarProps) {
  ...
  return (
    <div className="fixed left-0 top-0 hidden h-full w-[220px] overflow-y-auto border-r bg-muted/40 md:block lg:w-[280px]">
      <div className="flex h-full max-h-screen flex-col gap-2">
        <div className="flex h-14 flex-shrink-0 items-center border-b px-4 lg:h-[60px] lg:px-6">
          <Logo href="/dashboard" />
