...
//   return (
//     <main className="flex flex-1 flex-col gap-4 bg-rose-50/30 p-4 md:gap-8 md:p-8">
//       {/* Header Section */}
//       <div className="grid gap-4 md:grid-cols-1">
//         <Card className="border-rose-200 shadow-sm">
//           <CardHeader className="rounded-t-lg bg-gradient-to-r from-rose-100 to-rose-50 pb-2">
//             <div className="flex items-start justify-between">
//               <div>
//                 <CardTitle className="text-2xl font-bold tracking-tight text-rose-900">
//                   {greeting}, {userName}!
//                 </CardTitle>
//                 <CardDescription className="mt-1 text-rose-700">
//                   Welcome to your store dashboard
//                 </CardDescription>
//               </div>
//               <div className="text-right">
//                 <div className="flex items-center text-sm font-medium text-rose-800">
//                   <Clock className="mr-1 h-4 w-4 text-rose-500" />
//                   {currentTime}
//                 </div>
//                 <div className="mt-1 flex items-center text-xs text-rose-600">
//                   <Calendar className="mr-1 h-3 w-3 text-rose-400" />
//                   {currentDate}
//                 </div>
//               </div>
//             </div>
