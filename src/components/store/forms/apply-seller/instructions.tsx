...
export default function Instructions() {
  return (
    <div className="top-15 absolute left-0 z-50 h-[calc(100vh-64px)] w-80 border-t-4 border-teal-500 bg-teal-100 px-4 py-3 text-teal-900 shadow-md lg:relative lg:w-full">
      <div className="flex">
        <div className="me-1">
        ...
        <div>
          ...
          {instructions.map((inst, index) => (
            <div key={index} className="mt-1 flex gap-x-1">
              <Dot className="w-4" />
