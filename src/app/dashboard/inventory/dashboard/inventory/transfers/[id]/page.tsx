...
//           </CardContent>
//           <div className="absolute -left-3 top-1/2 -translate-y-1/2 transform rounded-full border bg-background p-1">
...
//         <h2 className="mb-4 text-lg font-medium">Transfer Status</h2>
