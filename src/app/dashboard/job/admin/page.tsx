          ...
          <div className="col-md-6">
            <div className="card mb-4">
              <div className="card-body">
                ...
                <p className="card-text">{companyCount}</p>
              </div>
            </div>
          </div>
          <div className="col-md-6">
            <div className="card mb-4">
              <div className="card-body">
                ...
                <p className="card-text">{pendingJobCount}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6">
            <div className="card mb-4">
              <div className="card-body">
                ...
                <p className="card-text">{activeJobCount}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6">
            <div className="card mb-4">
              <div className="card-body">
                ...
                <p className="card-text">{appliedJobCount}</p>
              </div>
            </div>
          </div>
          <div className="col-md-6">
            <div className="card mb-4">
              <div className="card-body">
                ...
                <p className="card-text">{jobBookmarkCount}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col">
            <div className="card mb-4">
              ...
              >
                ...
                <p className="card-text">YOU CAN ADD MORE INFORMATION</p>
              </div>
            </div>
          </div>
        </div>
